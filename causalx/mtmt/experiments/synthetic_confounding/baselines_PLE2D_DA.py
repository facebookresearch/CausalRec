...
def evaluate_ple2d_da_all_scenarios():
    ...
    #}
    scenario_params = {
        'A': {'da_weight': 1, 'num_epochs': 150, 'lr': 0.002},    # Multiple outcomes + treatments
        'B': {'da_weight': 10, 'num_epochs': 250, 'lr': 0.002},     # Most complex case
        'C': {'da_weight': 10, 'num_epochs': 250, 'lr': 0.002},     # Most complex case
        'D': {'da_weight': 10, 'num_epochs': 100, 'lr': 0.001}     # Most complex case
    }
