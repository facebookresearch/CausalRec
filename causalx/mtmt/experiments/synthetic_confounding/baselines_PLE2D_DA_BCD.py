...
from DGP_confounding import generate_all_scenarios
...
def train_and_evaluate_ple2d_da(model, data, num_epochs=60, batch_size=256, da_weight=1.0, loss_th=1000.0, lr=0.001):
...
def evaluate_ple2d_da_all_scenarios():
    ...
    scenario_desc = {
        ...
        'B': 'Multiple T, Multiple O, With Conf 3.0',
        'C': 'Multiple T, Multiple O, With Conf 6.0',
        'D': 'Multiple T, Multiple O, With Conf 9.0'
    }
    
    
    # Define scenario-specific hyperparameters
    #scenario_params = {
    #    'A': {'da_weight': 1, 'num_epochs': 150},    # Multiple outcomes + treatments
    #     'B': {'da_weight': 10, 'num_epochs': 250},     # Most complex case
    #    'C': {'da_weight': 10, 'num_epochs': 250},     # Most complex case
    #    'D': {'da_weight': 10, 'num_epochs': 250}     # Most complex case
    #}
    scenario_params = {
        'A': {'da_weight': 1, 'num_epochs': 1, 'lr': 0.002},    # Multiple outcomes + treatments
        'B': {'da_weight': 10, 'num_epochs': 200, 'lr': 0.002},     # Most complex case
        'C': {'da_weight': 10, 'num_epochs': 200, 'lr': 0.002},     # Most complex case
