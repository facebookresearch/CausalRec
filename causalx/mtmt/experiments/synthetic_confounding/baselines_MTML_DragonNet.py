...
def evaluate_dragonnet_all_scenarios():
    ...
    scenario_desc = {
        ...
        'C': 'Multiple T, Multiple O, With Conf 5.0',
        'D': 'Multiple T, Multiple O, With Conf 8.0'
    }
    ...
    scenario_params = {
        ...
        'C': {'num_epochs': 150, 'alpha': 1.0},  # Equal weight for confounded scenario
        'D': {'num_epochs': 150, 'alpha': 1.0},  # Equal weight for confounded scenario
    }
