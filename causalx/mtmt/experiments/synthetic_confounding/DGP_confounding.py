...
def generate_all_scenarios(N=10000, d=10, num_outcomes=2, num_treatments=3,
    ...
    scenario_params = {
        ...
        'B': dict(num_outcomes=2, num_treatments=3, confounding_level=3.0),    # Multiple T, Multiple O, With Conf 3.0  
        'C': dict(num_outcomes=2, num_treatments=3, confounding_level=6.0),    # Multiple T, Multiple O, With Conf 6.0 
        'D': dict(num_outcomes=2, num_treatments=3, confounding_level=9.0),    # Multiple T, Multiple O, With Conf 9.0                                                   # Multiple T, Multiple O, With Conf
    }
