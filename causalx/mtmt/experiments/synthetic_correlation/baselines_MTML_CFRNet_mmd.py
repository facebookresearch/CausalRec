...
def evaluate_tarnet_all_scenarios():
    ...
    scenario_desc = {
        'A': 'Multiple T, Multiple O, Correlation 0.05',
        'B': 'Multiple T, Multiple O, Correlation 0.1',
        'C': 'Multiple T, Multiple O, Correlation 0.5',
        'D': 'Multiple T, Multiple O, Correlation 1.0'
    }
    
    # Define scenario-specific hyperparameters
    scenario_params = {
        'A': {'num_epochs': 120, 'da_weight': 20.0, 'loss_th': 1000.0},
        'B': {'num_epochs': 120, 'da_weight': 20.0, 'loss_th': 1000.0},
        'C': {'num_epochs': 120, 'da_weight': 20.0, 'loss_th': 1000.0},
        'D': {'num_epochs': 120, 'da_weight': 20.0, 'loss_th': 1000.0},
    }
