...
def generate_all_scenarios(N=10000, d=10, num_outcomes=2, num_treatments=3,
    ...
    scenario_params = {
        'A': dict(num_outcomes=2, num_treatments=3, confounding_level=3.0, outcome_correlation=0.05),  # Multiple T, Multiple O, correlation 0.05
        'B': dict(num_outcomes=2, num_treatments=3, confounding_level=3.0, outcome_correlation=0.1),    # Multiple T, Multiple O,  correlation 0.1
        'C': dict(num_outcomes=2, num_treatments=3, confounding_level=3.0, outcome_correlation=0.5),    # Multiple T, Multiple O, correlation 0.5
        'D': dict(num_outcomes=2, num_treatments=3, confounding_level=3.0, outcome_correlation=1.0),    # Multiple T, Multiple O, correlation 1.0
    }
