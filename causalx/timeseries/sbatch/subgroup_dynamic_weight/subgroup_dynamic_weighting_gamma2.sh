...
#SBATCH --output=/data/home/yilingliu/CausalTransformer/sbatch/subgroup_dynamic_weight_log/subgroupgamma2-%j.log
...
PYTHONPATH=. python3 runnables/train_multi.py \
    +dataset=cancer_sim \
    +backbone=ct \
    +backbone/ct_hparams/cancer_sim_subgroup_dynamic_weight=\'2\' \
    exp.seed=10
