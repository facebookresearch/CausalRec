...
#SBATCH --output=/data/home/yilingliu/CausalTransformer_avg/sbatch/marginal_crn_log/crn_marginal_gamma2-%j.log

cd /data/home/yilingliu/CausalTransformer_avg/
source venv/bin/activate
mlflow server --port=5004 &

PYTHONPATH=. python3 runnables/train_enc_dec.py \
    +dataset=cancer_sim \
    +backbone=crn \
    +backbone/crn_hparams/cancer_sim_marginal=\'2\' \
    exp.seed=10 \
    exp.mlflow_uri=http://127.0.0.1:5004
