...
#SBATCH --output=/data/home/yilingliu/CausalTransformer_avg/sbatch/subgroup_random_ct_log/subgroup_random_ct_gamma1-%j.log

cd /data/home/yilingliu/CausalTransformer_avg/
source venv/bin/activate
mlflow server --port=9001 &

PYTHONPATH=. python3 runnables/train_multi.py \
    +dataset=cancer_sim \
    +backbone=ct \
    +backbone/ct_hparams/cancer_sim_subgroup_random=\'1\' \
    exp.seed=10 \
    exp.mlflow_uri=http://127.0.0.1:9001
