...
#SBATCH --job-name=semi_crn_subgroup
...
#SBATCH --output=/data/home/yilingliu/CausalTransformer_avg/sbatch/semi_synthetic_crn_log/crn_subgroup-%j.log

cd /data/home/yilingliu/CausalTransformer_avg/
source venv/bin/activate
mlflow server --port=6003 &

PYTHONPATH=. python3 runnables/train_enc_dec.py \
    +dataset=mimic3_synthetic \
    +backbone=crn \
    +backbone/crn_hparams/mimic3_synthetic=1000_subgroup.yaml \
    exp.seed=10 \
    exp.mlflow_uri=http://127.0.0.1:6003
