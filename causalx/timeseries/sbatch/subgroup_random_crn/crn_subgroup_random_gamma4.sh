...
#SBATCH --output=/data/home/yilingliu/CausalTransformer_avg/sbatch/subgroup_random_crn_log/subgroup_random_crn_log_gamma4-%j.log

cd /data/home/yilingliu/CausalTransformer_avg/
source venv/bin/activate
mlflow server --port=8004 &

PYTHONPATH=. python3 runnables/train_enc_dec.py \
    +dataset=cancer_sim \
    +backbone=crn \
    +backbone/crn_hparams/cancer_sim_subgroup_random=\'4\' \
    exp.seed=10
    exp.mlflow_uri=http://127.0.0.1:8004
